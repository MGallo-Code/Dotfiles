...
# always a CLIENT, wired by setup.ps1 to reach the hubs on the mail host over Tailscale.
#
...
Write-Host "hub host bootstrap is macOS-only; Windows is always a CLIENT of host '$MailHost'." -ForegroundColor Yellow
